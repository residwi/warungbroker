                                ...
                                <div class="overview-item overview-item--c4">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            <h2 class="pb-2 display-5"><a href="artikelsinglepost.php?sp=<?= $row["id"] ?>"><?= substr ($row['judul'],0,40)  ?>...</a></h2>
                                            ...
                                            <div class="typo-articles">
                                              <p><h6 class="pb-4 display-5">
                                                <?= substr ($row["kontent"],0,100)  ?>.....<br><a href="artikelsinglepost.php?sp=<?= $row["id"] ?>">Selengkapnya...</a></h6>                                                
                                              </p>
                                            </div>
